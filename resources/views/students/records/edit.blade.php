...
@section('content')
    <form action="{{ route('student_records.update', $student_record->id) }}" method="POST">
        @csrf
        @method('PUT')
        <!-- Name -->
        <div class="card p-4">
            ...
            <div class="card-body text-center">
                <div class="row">
                    ...
                    <div class="col-sm-2">
                        ...
                        <input type="text" name="names" id="names" value="{{ $student_record->names }}" class="form-control" readonly autofocus>
                    ...
                    <div class="col-sm-2">
                        ...
                        <input type="number" name="inscription_number" id="inscription_number" value="{{ $student_record->inscription_number }}" class="form-control" required autofocus>
                ...
                <div class="row">
                    <div class="col-sm-3">
                        ...
                        <input type="number" name="identification" id="identification" value="{{ $student_record->identification }}" class="form-control" readonly autofocus>
                    ...
                    <div class="col-sm-3">
                        ...
                        <input type="text" name="gender" id="gender" class="form-control" value="{{ $student_record->gender }}" readonly>
                    ...
                    <div class="col-sm-3">
                        ...
                        <input type="date" name="birthdate" id="birthdate" value="{{ $student_record->birthdate }}" class="form-control" readonly autofocus>
                    ...
                    <div class="col-sm-3">
                        ...
                        <input type="text" name="place_of_birth" id="place_of_birth" value="{{ $student_record->place_of_birth }}" class="form-control" readonly autofocus>
                ...
                <div class="row">
                    <div class="col-sm-4">
                        ...
                        <input type="text" name="municipality" id="municipality" value="{{ $student_record->municipality }}" class="form-control" readonly autofocus>
                    ...
                    <div class="col-sm-2">
                        ...
                        <input type="text" name="state" id="state" value="{{ $student_record->state }}" class="form-control" readonly autofocus>
                    ...
                    <div class="col-sm-2">
                        ...
                        <input type="text" name="laterality" id="laterality" value="{{ $student_record->laterality }}" class="form-control" readonly autofocus>
                    ...
                    <div class="col-sm-2">
                        ...
                        <input type="number" name="weight" id="weight" value="{{ $student_record->weight }}" class="form-control" readonly autofocus>
                    ...
                    <div class="col-sm-2">
                        ...
                        <input type="number" name="height" id="height" value="{{ $student_record->height }}" class="form-control" readonly autofocus>
                ...
                <div class="row">
                    <div class="col-sm-2">
                        ...
                        <input type="number" name="footwear" id="footwear" value="{{ $student_record->footwear }}" class="form-control" readonly autofocus>
                    ...
                    <div class="col-sm-2">
                        ...
                        <input type="number" name="pants" id="pants" value="{{ $student_record->pants }}" class="form-control" readonly autofocus>
                    ...
                    <div class="col-sm-2">
                        ...
                        <input type="number" name="shirt" id="shirt" value="{{ $student_record->shirt }}" class="form-control" readonly autofocus>
                    ...
                    <div class="col-sm-2">
                        ...
                        <input type="number" name="brachial_measure" id="brachial_measure" value="{{ $student_record->brachial_measure }}" class="form-control" readonly autofocus>
                    ...
                    <div class="col-sm-4">
                        ...
                        <input type="number" name="birth_order" id="birth_order" value="{{ $student_record->birth_order }}" class="form-control" readonly autofocus>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <input type="text" name="disease" id="disease" value="{{ $student_record->disease }}" class="form-control" readonly autofocus placeholder="{{ __('Descripcion') }}">
                    ...
                    <div class="col-sm-6">
                        ...
                        <input type="email" name="email" id="email" value="{{ $student_record->email }}" class="form-control" placeholder="{{ __('alumno@correo.com') }}" readonly autofocus>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <input type="text" name="school_background" id="school_background" value="{{ $student_record->school_background }}" class="form-control" placeholder="{{ __('Ingrese el nombre del plantel educativo anterior') }}" readonly autofocus>
                ...
                <div class="row">
                    <div class="col-sm-4">
                        ...
                        <input type="text" name="state_actual" id="state_actual" value="{{ $student_record->state_actual }}" class="form-control" placeholder="{{ __('Actual') }}" readonly autofocus>
                    ...
                    <div class="col-sm-4">
                        ...
                        <input type="text" name="municipality_actual" id="municipality_actual" value="{{ $student_record->municipality_actual }}" class="form-control" placeholder="{{ __('Actual') }}" readonly autofocus>
                    ...
                    <div class="col-sm-4">
                        ...
                        <input type="text" name="parish_actual" id="parish_actual" value="{{ $student_record->parish_actual }}" class="form-control" placeholder="{{ __('Actual') }}" readonly autofocus>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <input type="text" name="sector" id="sector" value="{{ $student_record->sector }}" class="form-control" placeholder="{{ __('Actual') }}" readonly autofocus>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <input type="text" name="reference_point" id="reference_point" value="{{ $student_record->reference_point }}" class="form-control" placeholder="{{ __('Actual') }}" readonly autofocus>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <input type="text" name="pattern_lastnames" id="pattern_lastnames" value="{{ $student_record->pattern_lastnames }}" class="form-control" placeholder="{{ __('Apellidos') }}" required autofocus>
                    ...
                    <div class="col-sm-6">
                        ...
                        <input type="text" name="pattern_names" id="pattern_names" value="{{ $student_record->pattern_names }}" class="form-control" placeholder="{{ __('Nombres') }}" required autofocus>
                ...
                <div class="row">
                    <div class="col-sm-3">
                        ...
                        <input type="number" name="pattern_identification" id="pattern_identification" value="{{ $student_record->pattern_identification }}" class="form-control" placeholder="{{ __('Identificacion') }}" required autofocus>
                    ...
                    <div class="col-sm-3">
                        ...
                        <input type="text" name="pattern_state_of_birth" id="pattern_state_of_birth" value="{{ $student_record->pattern_state_of_birth }}" class="form-control" placeholder="{{ __('Estado de Nacimiento') }}" required autofocus>
                    ...
                    <div class="col-sm-3">
                        ...
                        <input type="date" name="pattern_birthdate" id="pattern_birthdate" value="{{ $student_record->pattern_birthdate }}" class="form-control" placeholder="{{ __('Fecha') }}" required autofocus>
                    ...
                    <div class="col-sm-3">
                        ...
                        <input type="text" name="pattern_place_of_birth" id="pattern_place_of_birth" value="{{ $student_record->pattern_place_of_birth }}" class="form-control" placeholder="{{ __('Lugar de Nacimiento') }}" required autofocus>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        ...
                        <input type="text" name="pattern_affinity" id="pattern_affinity" value="{{ $student_record->pattern_affinity }}" class="form-control" placeholder="{{ __('Afinidad') }}" required autofocus>
                ...
                <div class="row">
                    <div class="col-sm-8">
                        ...
                        <input type="text" name="pattern_profession" id="pattern_profession" value="{{ $student_record->pattern_profession }}" class="form-control" placeholder="{{ __('Descripcion') }}" required autofocus>
                    ...
                    <div class="col-sm-4">
                        ...
                        <input type="tel" name="pattern_phone" id="pattern_phone" value="{{ $student_record->pattern_phone }}" class="form-control" placeholder="{{ __('Activo') }}" required autofocus>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        ...
                        <input type="text" name="registration_made_by" id="registration_made_by" value="{{ $student_record->registration_made_by }}" class="form-control" placeholder="{{ __('Nombre y Apellido') }}" required autofocus>
                    ...
                    <div class="col-sm-4">
                        ...
                        <input type="date" name="inscription_date" id="inscription_date" value="{{ $student_record->inscription_date }}" class="form-control"required autofocus>
